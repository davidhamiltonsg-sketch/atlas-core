...
const PORTFOLIO_META: Record<ConstitutionId, { theme: string; name: string; version: string; placeholder: string; footer: string }> = {
  "atlas-core": {
    theme: "atlas-core",
    name: "Atlas Core",
    version: "v3.1 · GDEA · Sign in to continue",
  ...
  "silicon-brick-road": {
    ...
    version: "v3.2 · Flexible growth · Sign in to continue",
...
function LoginForm() {
  ...
  const Mark = PORTFOLIO_MARK[portfolio]
    ...
    <div data-theme={meta.theme} className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <Mark className="mb-4 h-16 w-16 drop-shadow-[0_12px_28px_hsl(var(--primary)/.28)]" />
