    ...
    <div className="space-y-5">
          ...
          <form onSubmit={handleAdd} className="p-5 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input name="ticker" required list="div-ticker-list" placeholder="IMID" className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500 transition-all uppercase" />
      ...
      {dividends.length === 0 ? (
        <div className="rounded-xl border border-border bg-card p-8 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">The governed UCITS holdings are accumulating share classes; separately posted cash distributions or tax adjustments can still be recorded here.</p>
        </div>
      ) : (
        <div className="rounded-xl border border-border bg-card overflow-hidden">
