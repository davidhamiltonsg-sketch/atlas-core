...
export function ShellClient({ title, subtitle, userName, isAdmin = false, constitutionId = "atlas-core", children }: ShellClientProps) {
  ...
  return (
    <div data-theme={constitutionId === "silicon-brick-road" ? "sbr" : "atlas-core"} className="atlas-shell flex h-dvh min-h-dvh overflow-hidden bg-background print:block print:h-auto print:overflow-visible">
