...
export const ATLAS_CORE: Constitution = {
  ...
  docPath: "/downloads/atlas-core-constitution-v10.5.html",
  ...
  decisionLadder: [],
  rules: [
    { category: "Authority", title: "The written constitution controls", description: "Atlas v10.5 governs. The app implements its thresholds and contribution-first decision process; any disagreement must be resolved in favour of the written constitution." },
