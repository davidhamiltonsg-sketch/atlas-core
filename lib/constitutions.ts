...
export const SILICON_BRICK_ROAD: Constitution = {
  ...
  decisionLadder: [
    ...
    { n: 6, title: "Is QQQM or SMH near its highest price in the last year (within 3%)?", detail: "→ Skip buying that fund this month. Put the money into VWRA instead. Avoid buying at the peak if you can help it." },
    { n: 7, title: "Is any fund below its target range?", detail: "→ Put the full monthly amount into whichever fund is the furthest below its range. Don't split it." },
  ...
  rules: [
    ...
    { category: "How to Split Your Money", title: "You invest in four funds only", description: "VWRA 50% · QQQM 25% · SMH 15% · A35 10%. Each has a comfortable range and a hard limit. New money is directed wherever the plan needs it; hard limits trigger mandatory action." },
    ...
    { category: "Keeping Things in Balance", title: "Buy to rebalance — don't sell", description: "When something is out of balance, fix it by buying more of what's too small — not by selling what's too big. You only sell in four situations: SMH over 20%, Phase III de-risking, buying the property, or an approved rule change." },
    ...
    { category: "Staying Disciplined", title: "A market drop is a buying opportunity", description: "When prices fall, keep investing the same amount. Don't panic, don't sell, don't stop. Markets have always recovered. Selling when things are down locks in a loss permanently." },
