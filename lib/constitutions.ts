...
export const ATLAS_CORE: Constitution = {
  ...
  funds: [
    { ticker: "VT",   name: "Vanguard FTSE All-World UCITS ETF (VWRA)",     role: "The big foundation — owns stocks from all over the world. Held as VWRA (Irish UCITS).",                           target: 52, rangeLow: 46, rangeHigh: 58, hardCap: 60, color: "#7c3aed" },
    { ticker: "QQQM", name: "Invesco NASDAQ-100 UCITS ETF (EQQQ)",          role: "The growth engine — the 100 biggest US tech companies. Held as EQQQ (Irish UCITS).",                             target: 23, rangeLow: 18, rangeHigh: 28, hardCap: 30, color: "#a78bfa" },
    { ticker: "SMH",  name: "VanEck Semiconductor UCITS ETF (SEMI)",        role: "The chip bet — semiconductor companies tied to AI and computing. Held as SEMI (Irish UCITS).",                    target: 10, rangeLow: 7,  rangeHigh: 12, hardCap: 12, color: "#c026d3" },
    { ticker: "VWO",  name: "Vanguard FTSE Emerging Markets UCITS ETF (VFEA)", role: "The geography balancer — extra exposure to emerging market economies. Held as VFEA (Irish UCITS).",           target: 8,  rangeLow: 5,  rangeHigh: 11, hardCap: 13, color: "#8b5cf6" },
    { ticker: "BTC",  name: "iShares Bitcoin Trust ETF (IBIT)",              role: "The wild card — high upside, but kept deliberately small to limit the damage if it falls. Hold until BTC recovers above cost basis, then reassess vehicle.", target: 7, rangeLow: 6, rangeHigh: 8, hardCap: 8, color: "#f59e0b" },
  ],
  skipAtHighPct: 3,
  decisionLadder: [],
  rules: [
