...
export const SILICON_BRICK_ROAD: Constitution = {
  ...
  rules: [
    ...
    { category: "Changing the Rules", title: "What happens if you don't reach S$120k in time", description: "If the portfolio reaches Phase III or IV but a suitable property is not available, continue accumulating in A35 and review the target annually. If the portfolio falls materially short of S$120k when a property decision must be made: (a) you use whatever is available plus CPF OA, or (b) you delay the purchase, or (c) you choose a lower-priced property. There is no automatic rule for this — it requires a deliberate decision. The plan does not guarantee S$120k will be enough; it maximises the probability of getting there. Write down your contingency plan now, before you need it." },
  ],
  scorecard: [
