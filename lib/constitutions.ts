...
export const SILICON_BRICK_ROAD: Constitution = {
  ...
  rules: [
    ...
    { category: "How to Split Your Money", title: "Target recalibration", description: "The S$120,000 target assumes a standard down-payment scenario. If your actual property budget, CPF contribution, or loan terms change materially, recalibrate the target — and check whether the phase thresholds (S$72k / S$96k / S$114k) still make sense relative to the new number. Review this annually at minimum." },
