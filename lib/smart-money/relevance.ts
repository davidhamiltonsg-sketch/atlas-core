export const ATLAS_TICKERS = ["VWRA", "EQAC", "SMH", "BTC", "IBIT", "DBMFE"] as const
...
export const COMPANY_RELEVANCE: Record<string, FundRelevance[]> = {
  ...
  AAPL: [{ atlasTicker: "EQAC", approximateWt: 0.09, reason: "Major Nasdaq-100 holding" }, { atlasTicker: "VWRA", approximateWt: 0.03, reason: "Global-market holding" }],
  MSFT: [{ atlasTicker: "EQAC", approximateWt: 0.09, reason: "Major Nasdaq-100 holding" }, { atlasTicker: "VWRA", approximateWt: 0.03, reason: "Global-market holding" }],
