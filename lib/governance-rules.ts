...
export function governanceRules(id:ConstitutionId):AppGovernanceRule[]{
  ...
  return [
    ...
    {id:"liquidity",category:"Behaviour",title:"Personal safety comes before contributions",rule:"Green: continue. Amber: pause optional increases. Red: suspend contributions and protect essential spending.",why:"A growth portfolio cannot substitute for external emergency cash.",appAction:"Never score DBMFE, Bitcoin or an equity ETF as emergency liquidity."},
    {id:"crash",category:"Behaviour",title:"A falling price is not a sell rule",rule:"No leverage, margin or panic selling. Wait 72 hours before an unscheduled discretionary sale unless delay is unsafe.",why:"Fear makes permanent decisions feel urgent during temporary market stress.",appAction:"Show the constitutional questions and cooling-off time instead of a sell button."},
    {id:"forecast",category:"Forecasts",title:"Forecasts describe ranges, not promises",rule:"Use contribution-aware scenarios and Monte Carlo assumptions; never treat a percentile or base case as guaranteed.",why:"The model cannot know future returns, volatility, correlations, inflation or sequence.",appAction:"Show assumptions, as-of date, difficult/base/strong paths and model limitations."},
    {id:"returns",category:"Performance",title:"Separate cash flows from investment return",rule:"Contributions, withdrawals and migration trades are not gains or losses.",why:"Raw value changes can make a deposit look like performance.",appAction:"Use cash-flow-adjusted return where available and label raw value movement honestly."},
    {id:"history",category:"Records",title:"Never rewrite instrument history",rule:atlas?"Keep VT, VWO, QQQM, US SMH and GBTC with their original basis and flows; retain IBIT as the target Bitcoin vehicle.":"Keep any closed or out-of-plan instrument with its original basis and flows.",why:"A replacement is a new purchase, not a renamed old security.",appAction:"Close absent positions only from an authoritative complete IBKR report; never delete their ledger."},
    {id:"review",category:"Reviews",title:"Review at the right rhythm",rule:"Monthly reconciliation; quarterly bands and sources; annual purpose, instruments, beneficiaries and legal/tax review.",why:"A fixed rhythm reduces both neglect and compulsive tinkering.",appAction:"Surface due items and archive completed evidence."},
    {id:"amend",category:"Amendments",title:"Change rules slowly",rule:"A material change needs written evidence, a version increment and a 30-day cooling-off period except genuine emergencies.",why:"Excitement, fear and recent performance are poor constitution writers.",appAction:"Record owner, reason, authority, start date, expiry and remediation."},
  ]
}
