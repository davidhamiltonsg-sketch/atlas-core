...
async function main() {
  ...
  // v5.2 holdings
  const holdings = [
    { ticker: "VT",   name: "Vanguard Total World Stock ETF",       targetPct: 52, hardCapPct: 62, toleranceBand: 5, color: "#6366f1", units: 428,  price: 155.52, value: 85209.84 },
    { ticker: "QQQM", name: "Invesco NASDAQ 100 ETF",                targetPct: 23, hardCapPct: 31, toleranceBand: 4, color: "#8b5cf6", units: 63,   price: 295.02, value: 23792.85 },
    { ticker: "SMH",  name: "VanEck Semiconductor ETF",              targetPct: 10, hardCapPct: 15, toleranceBand: 2, color: "#a78bfa", units: 24,   price: 573.79, value: 17628.63 },
    { ticker: "VWO",  name: "Vanguard FTSE Emerging Markets ETF",    targetPct: 8,  hardCapPct: 12, toleranceBand: 2, color: "#c4b5fd", units: 109,  price: 58.94,  value: 8223.72  },
  ...
  const rules = [
    ["VT — Healthy Range 45–57%", "VT target 52%. Healthy range 45–57%. Soft drift below 45% or above 57% — redirect contributions. Hard drift below 40% or above 62% — rebalance review required.", "VT Governance"],
    ["VT — Diversification Anchor", "VT is the diversification anchor, behavioural stabiliser, and anti-fragility layer.", "VT Governance"],
    ["VT Underweight Response", "Portfolio is becoming excessively thematic. Redirect all contributions toward VT until restored to healthy range.", "VT Governance"],
    ["VT Overweight Response", "Portfolio is becoming excessively defensive. Redirect contributions toward QQQM to restore balance.", "VT Governance"],
    ["QQQM — Healthy Range 19–27%", "QQQM target 23%. Healthy range 19–27%. Soft drift below 19% or above 27%. Hard drift below 16% or above 31%.", "QQQM Governance"],
    ["QQQM — Digital Economy Engine", "QQQM is the portfolio's dominant long-term growth engine — software, cloud, AI monetisation, enterprise digitisation.", "QQQM Governance"],
    ["QQQM Underweight Response", "Portfolio is underexposed to digital expansion. Increase contributions to QQQM.", "QQQM Governance"],
    ["QQQM Overweight Response", "Portfolio is excessively US mega-cap dependent. Pause incremental QQQM accumulation.", "QQQM Governance"],
    ["SMH — Healthy Range 8–12%", "SMH target 10%. Healthy range 8–12%. Soft drift above 12% — halt accumulation. Hard drift above 15% — selectively trim.", "SMH Governance"],
    ["SMH — AI Infrastructure Tilt Identity Rule", "SMH is a targeted AI infrastructure tilt, not the portfolio foundation. Semiconductor concentration must never become the dominant portfolio risk factor.", "SMH Governance"],
    ["VWO — Healthy Range 6–10%", "VWO target 8%. Healthy range 6–10%. Soft drift below 6% or above 10%. Hard drift below 4% or above 12%.", "VWO Governance"],
    ...
    ["Semiconductor Dependency — Cap 16%/20%", "Total semiconductor exposure must remain below 16%. Elevated 16–20%: pause SMH accumulation. Excessive above 20%: halt SMH; redirect to VT.", "Overlap & Concentration"],
    ["Digital Economy Dependency — Cap 48%/54%", "Combined digital economy exposure must remain below 48%. Elevated 48–54%: increase VT/VWO. Excessive above 54%: halt QQQM and SMH.", "Overlap & Concentration"],
    ["US Market Dependency — Cap 70%/78%", "Total effective US exposure must remain below 70%. Elevated 70–78%: prioritise VT and VWO. Excessive above 78%: pause all tech concentration increases.", "Overlap & Concentration"],
    ["AI Infrastructure Cluster — Cap 38%/46%", "Combined AI infrastructure exposure must remain below 38%. Elevated 38–46%: reduce SMH; favour VT. Excessive above 46%: halt SMH; reduce QQQM.", "Overlap & Concentration"],
    ["Nvidia Exposure Cap — Soft 10%, Hard 13%", "Effective Nvidia look-through exposure: soft cap 10%, hard cap 13%. Hard breach: pause all SMH and QQQM accumulation.", "Overlap & Concentration"],
    ["Microsoft Exposure Cap — Soft 10%, Hard 13%", "Effective Microsoft look-through exposure: soft cap 10%, hard cap 13%. Hard breach: pause QQQM accumulation; redirect to VT.", "Overlap & Concentration"],
