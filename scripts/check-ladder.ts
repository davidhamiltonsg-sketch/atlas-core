/**
 * Atlas Core — Art. XIII Ladder engine scenario checks (Constitution v1.1).
 *
 * Validates the 8-step ladder's precedence order and v1.1 skip-rule placement.
...
console.log("Atlas Core — Art. XIII Ladder scenario checks (v1.1)\n")
...
console.log(`\n${"─".repeat(54)}`)
if (failures === 0) {
  console.log(`  All ${passes} checks passed. Art. XIII Ladder v1.1 ✓`)
  process.exit(0)
} else {
